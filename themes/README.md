...
| :--: | :--: | :--: |
| `default` ![default][default] | `dark` ![dark][dark] | `transparent` ![transparent][transparent] |
| `gruvbox_light` ![gruvbox_light][gruvbox_light] | `gruvbox` ![gruvbox][gruvbox] | `shadow_red` ![shadow_red][shadow_red] |
| `vue` ![vue][vue] | `vue-dark` ![vue-dark][vue-dark] | `shadow_blue` ![shadow_green][shadow_green] |
| `solarized-light` ![solarized-light][solarized-light] | `solarized-dark` ![solarized-dark][solarized-dark] | `shadow_blue` ![shadow_blue][shadow_blue] |
| `chartreuse-light` ![chartreuse-light][chartreuse-light] | `chartreuse-dark` ![chartreuse-dark][chartreuse-dark] | [Add your theme][add-theme] |
